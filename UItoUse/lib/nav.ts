import {
  ...
  Newspaper, History, FileText, Settings, Rocket, Zap, CloudLightning, Award, Shield, Target, Activity,
} from "lucide-react";
...
export const navItems = [
  ...
  { title: "Intraday Trading", url: "/intraday-trading", icon: Activity, adminOnly: false },
  { title: "Penny Storm", url: "/penny-storm", icon: CloudLightning, adminOnly: false },
  { title: "Option Signals", url: "/option-signals", icon: Target, adminOnly: false },
